...
function ArchNodeView({ data, selected }: NodeProps<ArchNode>) {
  return (
    <div
      ...
      style={{
        borderColor: selected ? 'var(--tbe-border-active)' : data.group === 'actor' ? 'rgba(255,255,255,0.3)' : 'var(--tbe-border)',
        minWidth: 130,
      }}
    >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        {!isTouch && (
          <div className="mt-12 hidden gap-6 lg:grid lg:grid-cols-[minmax(0,1fr)_300px]">
            <div
              className="tbe-blueprint h-[480px] border border-white/12 bg-[var(--tbe-bg-2)]/70"
              role="group"
