    ...
    <section id={TBE_SECTIONS.lab} ref={sectionRef} className="relative py-32" aria-label="Laboratório de tecnologia">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="grid gap-px bg-[#0b1b33]/10 sm:grid-cols-2">
        ...
        <div className="mt-8 grid min-h-44 overflow-hidden border border-[var(--tbe-border-active)]/50 bg-[var(--tbe-bg-ui)] md:grid-cols-[1fr_1.5fr]" aria-live="polite">
          <div className="tbe-blueprint flex items-center justify-center border-b border-[#0b1b33]/10 p-8 md:border-b-0 md:border-r"><div className="relative h-20 w-20 border border-[var(--tbe-tq)]/60"><span className="absolute inset-3 border border-[#0b1b33]/20" /><span className="absolute left-1/2 top-1/2 h-2 w-2 -translate-x-1/2 -translate-y-1/2 bg-[var(--tbe-tq)]" /></div></div>
