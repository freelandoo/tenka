...
export const FABRIC_COLORS = /* glsl */ `
  const vec3 TQ = vec3(0.0, 0.941, 0.816);        // #00F0D0
  const vec3 TQ_LIGHT = vec3(0.514, 1.0, 0.941);  // #83FFF0
  const vec3 TQ_DARK = vec3(0.0, 0.373, 0.349);   // #005F59
  const vec3 NEUTRAL = vec3(1.0, 1.0, 1.0);
`;
